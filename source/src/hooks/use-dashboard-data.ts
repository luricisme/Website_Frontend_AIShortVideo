...
export const useDashboardData = () => {
        ...
        switch (dateRange) {
            case "this-week":
                return {
                    ...
                    followers: 1245,
                    engagement: 8.7,
                    // Thêm trường dữ liệu mới để hiển thị thay đổi
                    videoDelta: 2,
                    viewsGrowth: 15.2,
                    followersDelta: 45,
                    engagementDelta: 1.2,
    ...
    // Dữ liệu video gần đây có thể giữ nguyên vì đây là danh sách video nổi bật
    const recentVideos = useMemo(() => {
        ...
        // Có thể thêm logic để sắp xếp lại video nổi bật theo khoảng thời gian
