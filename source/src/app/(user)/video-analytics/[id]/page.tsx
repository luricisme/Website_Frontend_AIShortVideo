                                    ...
                                    <CardContent>
                                        <div className="space-y-4">
                                            ...
                                            <div className="pt-2">
                                                ...
                                                <Progress
                                                    value={
                                                        (data.views / videoData.totalViews) * 100
                                                    }
                    ...
                    <TabsContent value="engagement" className="mt-6">
                        <Card className="bg-zinc-900 border-zinc-800">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    {dateRange === "this-week" && "Phân tích tương tác 7 ngày qua"}
                                    {dateRange === "this-month" && "Phân tích tương tác tháng này"}
                                    {dateRange === "3-months" &&
                                        "Phân tích tương tác 3 tháng gần đây"}
                                    {dateRange === "all-time" &&
                                        "Phân tích tương tác từ khi phát hành"}
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
