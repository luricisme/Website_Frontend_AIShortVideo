            ...
            >
                ...
                {video.duration && !isHovering && (
                    <div className="absolute bottom-2 right-2 bg-black bg-opacity-70 text-white text-xs px-2 py-1 rounded">
                        ...
                        {video.duration % 60 < 10 ? `0${video.duration % 60}` : video.duration % 60}
                    </div>
                )}

                {isHovering && (
                    <div className="absolute bottom-2 right-2 bg-red-500 h-2 w-2 rounded-full animate-pulse" />
                )}
            </div>
            <div className="flex flex-col mt-2">
                <div className="text-sm font-bold text-white line-clamp-2">{video.title}</div>
