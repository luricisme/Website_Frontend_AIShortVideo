    ...
    Vietnamese: [
        {
            ...
            label: "Hoài My (Nữ)",
            description: "Giọng Bắc, tự nhiên, phù hợp đọc tin tức",
        },
        {
            value: "vi-VN-NamMinhNeural",
            label: "Nam Minh (Nam)",
            description: "Giọng Bắc, trầm ấm",
        },
    ],
    English: [
        {
            ...
            label: "Jenny (Nữ)",
            description: "Giọng Mỹ phổ thông, đa dụng",
        },
        {
            value: "en-US-DavisNeural",
            label: "Davis (Nam)",
            description: "Giọng trầm, chuyên nghiệp",
        },
    ],
    Chinese: [
        {
            ...
            label: "Xiaoxiao (Nữ)",
            description: "Giọng nữ trẻ trung, có thể đa cảm xúc",
        },
        {
            value: "zh-CN-YunyangNeural",
            label: "Yunyang (Nam)",
            description: "Giọng phát thanh viên",
        },
    ],
};
    ...
    const handleGenerateAudio = async () => {
        ...
        try {
            const response = await fetch(
                `${envPublic.NEXT_PUBLIC_API_URL}/create-video/generate-audio`,
                {
                    method: "POST",
                    headers: {
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <Card className="max-w-4xl mx-auto px-4">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>
                            Tạo giọng đọc từ script ({getLanguageDisplayName()}) hoặc tải lên file
                            audio của bạn
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                            ...
                            <TabsContent value="generate" className="space-y-6 mt-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value) =>
                                                updateAudioData({ voiceType: value })
                                            }
                                        >
                                            <SelectTrigger>
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) =>
                                            updateAudioData({ customText: e.target.value })
                                        }
                                ...
                                <div className="text-center space-y-6">
                                    ...
                                    <div>
                                        <Button
                                            ...
                                            size="lg"
                                            variant={
                                                audioData.isRecording ? "destructive" : "default"
                                            }
                                            className="px-8 py-3"
                                        >
                                            {audioData.isRecording ? (
                            ...
                            <div className="mt-8 p-6 rounded-lg border">
                                <div className="flex items-center justify-between mb-4">
                                    <Label className="text-lg font-semibold">
                                        Danh sách Audio ({audioFiles.length})
                                    </Label>
                                        ...
                                        >
                                            <div className="flex items-center justify-between mb-3">
                                                <div className="flex items-center gap-3">
                                                    <input
                                                        ...
                                                        onChange={() =>
                                                            toggleAudioSelection(audioFile.id)
                                                        }
                                            ...
                                            <div className="flex items-center space-x-4">
                                                ...
                                                <div
                                                    ...
                                                    onClick={(e) =>
                                                        handleProgressClick(e, audioFile.id)
                                                    }
                                                >
                                                    <div
                                                        ...
                                                        style={{
                                                            width: `${
                                                                audioProgress[audioFile.id] || 0
                                                            }%`,
                                                        }}
                                                    />
                                                </div>
                                                <span className="text-sm text-gray-500 min-w-[100px]">
                                                    {formatTime(currentTimes[audioFile.id] || 0)} /{" "}
                                                    {formatTime(audioDurations[audioFile.id] || 0)}
                                                </span>
                                                <Button
                                                    size="sm"
                                                    variant="outline"
                                            ...
                                            <audio
                                                ...
                                                onLoadedMetadata={() =>
                                                    handleLoadedMetadata(audioFile.id)
                                                }
